...
tar_plan(
 ...
 tar_target(facilities_filepath,
            'C:\Users\dlopez\AppData\Local\Temp\RtmpYXBAzi\file3fbc30b6d42.rds',
            format = 'file'),
...
tar_target(
  facilities,load_facilties_data(facilities_filepath, 'C:\Users\dlopez\AppData\Local\Temp\RtmpYXBAzi\file3fbc30b6d42.rds')
